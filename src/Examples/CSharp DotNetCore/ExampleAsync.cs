...
namespace CSharpDotNetCore
{
    class ExampleAsync
    {
        ...
        {
            var myTag = new Tag(IPAddress.Parse("10.10.10.10"), "1,0", PlcType.Logix, DataType.DINT, "PROGRAM:SomeProgram.SomeDINT", 5000);
        ...
        public static async void SyncAsyncComparison()
        {
            ...
            for (int ii = 0; ii < 10; ii++)
            {
                ...
                .Select(i => new Tag(IPAddress.Parse("192.168.0.10"), "1,0", PlcType.Logix, DataType.DINT, $"MY_DINT_ARRAY_1000[{i}]", 5000 ))
                .ToList();
        ...
        public static void ParallelBlockingReads()
        {
            ...
            Console.WriteLine("This method measures the speed of synchronous vs asynchronous reads");
            var myTag = new Tag(IPAddress.Parse("192.168.0.10"), "1,0", PlcType.Logix, DataType.DINT, "Dummy", 5000);
