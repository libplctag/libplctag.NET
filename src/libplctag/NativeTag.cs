...
namespace libplctag
{
    class NativeTag : INativeTag
    {
        ...
        public int plc_tag_get_string(Int32 tag_id, int string_start_offset, StringBuilder buffer, int buffer_length)   => plctag.plc_tag_get_string(tag_id, string_start_offset, buffer, buffer_length);
        public int plc_tag_set_string(Int32 tag_id, int string_start_offset, string string_val)                         => plctag.plc_tag_set_string(tag_id, string_start_offset, string_val);
        public int plc_tag_get_string_length(Int32 tag_id, int string_start_offset)                                     => plctag.plc_tag_get_string_length(tag_id, string_start_offset);
        public int plc_tag_get_string_capacity(Int32 tag_id, int string_start_offset)                                   => plctag.plc_tag_get_string_capacity(tag_id, string_start_offset);
        public int plc_tag_get_string_total_length(Int32 tag_id, int string_start_offset)                               => plctag.plc_tag_get_string_total_length(tag_id, string_start_offset);
