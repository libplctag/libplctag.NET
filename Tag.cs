...
namespace libplctag
{
    ...
    public class Tag : IDisposable
    {
        ...
        public StatusCode GetStatus() => (StatusCode)Dll.plc_tag_status(_pointer);

        public ulong GetUInt64(int offset) => Dll.plc_tag_get_uint64(_pointer, offset);
        public void SetUInt64(int offset, ulong value) => Dll.plc_tag_set_uint64(_pointer, offset, value);

        public long GetInt64(int offset) => Dll.plc_tag_get_int64(_pointer, offset);
        public void SetInt64(int offset, long value) => Dll.plc_tag_set_int64(_pointer, offset, value);

        public uint GetUInt32(int offset) => Dll.plc_tag_get_uint32(_pointer, offset);
        public void SetUInt32(int offset, uint value) => Dll.plc_tag_set_uint32(_pointer, offset, value);

        public int GetInt32(int offset) => Dll.plc_tag_get_int32(_pointer, offset);
        public void SetInt32(int offset, int value) => Dll.plc_tag_set_int32(_pointer, offset, value);

        public ushort GetUInt16(int offset) => Dll.plc_tag_get_uint16(_pointer, offset);
        public void SetUInt16(int offset, ushort value) => Dll.plc_tag_set_uint16(_pointer, offset, value);

        public short GetInt16(int offset) => Dll.plc_tag_get_int16(_pointer, offset);
        public void SetInt16(int offset, short value) => Dll.plc_tag_set_int16(_pointer, offset, value);

        public byte GetUInt8(int offset) => Dll.plc_tag_get_uint8(_pointer, offset);
        public void SetUInt8(int offset, byte value) => Dll.plc_tag_set_uint8(_pointer, offset, value);

        public sbyte GetInt8(int offset) => Dll.plc_tag_get_int8(_pointer, offset);
        public void SetInt8(int offset, sbyte value) => Dll.plc_tag_set_int8(_pointer, offset, value);

        public double GetFloat64(int offset) => Dll.plc_tag_get_float64(_pointer, offset);
        public void SetFloat64(int offset, double value) => Dll.plc_tag_set_float64(_pointer, offset, value);

        public float GetFloat32(int offset) => Dll.plc_tag_get_float32(_pointer, offset);
        public void SetFloat32(int offset, float value) => Dll.plc_tag_set_float32(_pointer, offset, value);
